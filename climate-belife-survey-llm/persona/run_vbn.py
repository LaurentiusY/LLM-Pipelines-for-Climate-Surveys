...
def generate_prompts_for_sample(row_id, persona_text):
    def mk_task(task_type, description, question_text, required_format):
        return {
    ...
    return {
        ...
        "task_1": mk_task("belief", "Climate Attitude Assessment", QUESTION_1, REQUIRED_FORMAT_1),
        "task_2": mk_task("policy", "Policy Support Assessment", QUESTION_2, REQUIRED_FORMAT_2),
        "task_3": mk_task("share",  "Social Media Sharing Willingness", QUESTION_3, REQUIRED_FORMAT_3),
        "task_4": mk_task("trees",  "Pro-environmental Effort Task (One-shot)", QUESTION_4_ONESHOT, REQUIRED_FORMAT_4)
    }
