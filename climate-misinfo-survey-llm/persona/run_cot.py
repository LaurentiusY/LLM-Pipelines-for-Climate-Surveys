...
# 【配置区】
# =========================================================================
TARGET_CONDITION = 'All'  # 'All' | 'Control' | 'Cognitive' | 'Socioaffective'
INPUT_FILE = 'data/Showdown_short.csv'
PROFILE_MODE = 'both'  # 'demographics' | 'psychology' | 'both'
...
def generate_prompts_for_sample(row_id, persona_text):
    ...
    return {
        ...
        "task_1": mk_task("task_1", "Affect Response to Science-Denial Tweets", QUESTION_1, REQUIRED_FORMAT_1),
        "task_2": mk_task("task_2", "Affect Response to Action-Opposition Tweets", QUESTION_2, REQUIRED_FORMAT_2),
        "task_3": mk_task("task_3", "Climate Change Beliefs", QUESTION_3, REQUIRED_FORMAT_3),
        "task_4": mk_task("task_4", "Truth Discernment (MIST)", QUESTION_4, REQUIRED_FORMAT_4),
    }
